    ...
    function (dialogService, editorState) {
        return {
            open: function (options) {
                ...
                var o = $.extend({}, {
                    template: "/App_Plugins/EventCalendar/GridEditors/Dialogs/EventListDialog.html",
                    show: true,
                    requireName: true,
                }, options);
...
angular.module('umbraco.services').factory('EventCalendar.GridEditors.Services.CalendarDialogService',
    function (dialogService, editorState) {
        return {
            open: function (options) {
                ...
                var o = $.extend({}, {
                    template: "/App_Plugins/EventCalendar/GridEditors/Dialogs/CalendarDialog.html",
                    show: true,
                    requireName: true,
                }, options);
